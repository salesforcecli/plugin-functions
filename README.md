...
@salesforce/plugin-functions/0.0.2 darwin-x64 node-v12.18.4
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/env/create/compute.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/create/compute.ts)_
...
_See code: [src/commands/env/delete.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/delete.ts)_
...
_See code: [src/commands/env/list.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/list.ts)_
...
_See code: [src/commands/env/log/tail.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/log/tail.ts)_
...
_See code: [src/commands/env/logdrain/add.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/logdrain/add.ts)_
...
_See code: [src/commands/env/logdrain/list.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/logdrain/list.ts)_
...
_See code: [src/commands/env/logdrain/remove.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/logdrain/remove.ts)_
...
_See code: [src/commands/env/var/get.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/var/get.ts)_
...
_See code: [src/commands/env/var/list.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/var/list.ts)_
...
_See code: [src/commands/env/var/set.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/var/set.ts)_
...
_See code: [src/commands/env/var/unset.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/env/var/unset.ts)_
...
_See code: [src/commands/generate/function.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/generate/function.ts)_
...
_See code: [src/commands/generate/project.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/generate/project.ts)_
...
_See code: [src/commands/login/functions.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/login/functions.ts)_
...
_See code: [src/commands/project/deploy/functions.ts](https://github.com/heroku/sf-plugin-functions/blob/v0.0.2/src/commands/project/deploy/functions.ts)_
<!-- commandsstop -->
